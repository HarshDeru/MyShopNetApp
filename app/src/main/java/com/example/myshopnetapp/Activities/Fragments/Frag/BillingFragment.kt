...
import com.example.myshopnetapp.Activities.Fragments.ViewModel.BillingViewModel
import com.example.myshopnetapp.Activities.Fragments.ViewModel.OrderViewModel
import com.example.myshopnetapp.Adapters.AddressAdapter
...
import com.example.myshopnetapp.databinding.FragmentBillingBinding
...
class BillingFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupAddressRecycleView()
        setupBillingRecycleView()
    ...
    private fun setupAddressRecycleView() {
    ...
    private fun setupBillingRecycleView() {
