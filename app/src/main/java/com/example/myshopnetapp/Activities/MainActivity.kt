...
import com.example.myshopnetapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getImagesByteArrays(): List<ByteArray> {
        ...
        selectedImages.forEach {
            ...
            val imageMap = MediaStore.Images.Media.getBitmap(contentResolver,it)
            if(imageMap.compress(Bitmap.CompressFormat.JPEG,100,stream)){
