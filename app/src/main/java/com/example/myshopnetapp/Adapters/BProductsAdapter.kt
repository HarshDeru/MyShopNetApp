...
import com.example.myshopnetapp.databinding.ProductViewItemBinding

// Define an adapter class for the RecyclerView
class BProductsAdapter: RecyclerView.Adapter<BProductsAdapter.BestProductsViewHolder>(){

    // Define a ViewHolder class for each item in the RecyclerView
    inner class BestProductsViewHolder(private val binding: ProductViewItemBinding): RecyclerView.ViewHolder(binding.root){
        ...
        fun bind (product: Product) {
            binding.apply{
                ...
                textVOldPrice.text = "£ ${product.price}"
